...
from policyflux.gpu_utils import get_array_module, has_cupy, to_cpu_array
from policyflux.congress.congress import TheCongress
from policyflux.public_opinion.regime import PublicRegime
from policyflux.utils import RewardComputer as BaseRewardComputer
        ...
        for sim_idx in iterator:
            ...
            for t in t_iterator:
                ...
                for i, (actor_idx, vote_action) in enumerate(actor_votes):
                    ...
                    if actor.use_dqn and actor.dqn_agent is not None:
                        try:
                            # Determine party line from policyflux.congress heuristic
